...
$sql = "SELECT cjb.*,kcb.*,xsb.* FROM cjb,kcb,xsb WHERE cjb.学号=xsb.学号 AND kcb.课程号=cjb.课程号";
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			...
			<dd style="display: block;">
				<ul>
					<li ><a href="student-list.php" title="会员列表">学生列表</a></li>
					<!--<li ><a href="member-del.html" title="删除的会员">删除的会员</a></li>-->
					<li class="current"><a href="student-score-list.php" title="等级管理">成绩列表</a></li>
