...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		...
		<dl id="menu-member">
			<dt class="selected"><i class="Hui-iconfont">&#xe60d;</i> 学生成绩管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd style="display: block;">
				<ul>
					<li class="current"><a href="student-list.php" title="会员列表">学生列表</a></li>
					<li><a href="student-score-list.php" title="成绩列表">成绩列表</a></li>
		...
		<dl id="menu-tongji">
			<dt><i class="Hui-iconfont">&#xe61a;</i> 成绩统计<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-c"> 日期范围：
				...
				<input type="text" class="input-text" style="width:250px" placeholder="输入会员名称、电话、邮箱" id="serarchbox" name="">
				<button type="button" class="btn btn-success radius" id="" name="" onclick="student_search((document.getElementById('serarchbox').value),10086)">
                    <i class="Hui-iconfont">&#xe665;</i> 搜用户</button>
			</div>
			<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加用户','member-add.html','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> <span class="r">共有数据：<strong>100</strong> 条</span> </div>
			<div class="mt-20">
                    ...
                    ?>
						<tr class="text-c">
							...
							<td><?php
                                ...
                                ?></td>
							<td><?php echo $value['出生时间']?></td>
							<td><?php echo $value['专业']?></td>
							<td class="text-l"><?php echo $value['总分数']?></td>
...
/*学生-搜索*/
function student_search(obj,id){
    console.log(obj);
}
/*用户-添加*/
